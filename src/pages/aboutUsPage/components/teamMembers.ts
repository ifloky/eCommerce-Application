...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    name: 'Kirill',
    age: 34,
    about: 'I graduated from high school in 2006, in 2014 I graduated from Mogilev State University with a degree in jurisprudence. At the moment I am finishing my studies on the JavaScript frontend course at the Rolling Scope School. Amat victoria curam(Gaius Valerius Catullus)',
