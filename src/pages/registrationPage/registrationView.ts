...
function createRegistrationField(array: FieldsInfo[]): string { 
...
export function createFinalFieldForm (): string {
  return finalFieldForm;
}
...
createRegistrationField(registrationFeildsInfo);
